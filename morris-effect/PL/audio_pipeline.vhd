...
begin
    ...
    --------------------------------------------------
    -- FIFO read control: read when not empty and AXIS is ready for data
    sig_fifo_rd <= (not sig_fifo_empty) and axis_tready;
    ...
    -- TDATA (now comes from effects pipeline output instead of FIFO)
